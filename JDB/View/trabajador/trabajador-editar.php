...
<ol class="breadcrumb">
  <li><a href="?c=Trabajador">Trabajador</a></li>
  <li class="active"><?php echo $alm->id != null ? 'Editar Registro' : 'Nuevo Registro'; ?></li>
</ol>

<form id="frm-trabajador" action="?c=Trabajador&a=Guardar" method="post" enctype="multipart/form-data">
...
<script>
    $(document).ready(function(){
        $("#frm-trabajador").submit(function(){
